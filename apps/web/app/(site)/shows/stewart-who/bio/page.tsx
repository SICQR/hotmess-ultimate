...
export default function Bio(){ const m:any = loadMap()['stewart-who'] || {}; return (<main className="container">
...
<p><strong>History.</strong> London club icon—DJ, writer, broadcaster.</p>
<p><strong>Current.</strong> On‑air host and interviewer across HOTMESS.</p>
<p><strong>Next.</strong> Long‑form interviews and late‑night specials.</p>

    <ExternalLinks links={m.links} />
    <p style={{marginTop:12}}><a className="cta" href="/shows/stewart-who">Back to show</a></p>
  </section>
</main>) }
