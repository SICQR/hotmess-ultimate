...
export default function Bio(){ const m:any = loadMap()['tony-english'] || {}; return (<main className="container">
...
<p><strong>History.</strong> UK DJ/producer, big‑room energy.</p>
<p><strong>Current.</strong> “Hotmess — Tony English Remix”.</p>
<p><strong>Next.</strong> Club‑forward remixes and guest slots.</p>

    <ExternalLinks links={m.links} />
    <p style={{marginTop:12}}><a className="cta" href="/shows/tony-english">Back to show</a></p>
  </section>
</main>) }
